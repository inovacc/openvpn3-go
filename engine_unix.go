...
// SetLogger is a no-op until the Linux engine is wired.
func SetLogger(*slog.Logger) {}

// Connect reports the Linux connector is not implemented yet.
...
// Available reports false: the Linux connector is not implemented in v0.
